...
const ru: Record<string, string> = {
  ...
  'booking.noPrivateRate': 'На источнике нет однозначного индивидуального тарифа для автоматического расчёта.',
  'booking.noPrivateRateText': 'Мы не придумываем цену. В Admin будет задаваться утверждённая тарифная сетка MAX TOUR — после этого этот тур тоже пойдёт в online checkout.',
  'booking.priceServer': 'Цена индивидуального формата определяется сервером по опубликованной тарифной сетке конкретной экскурсии.',
  'booking.transferText': 'Для удалённых районов применяются опубликованные MAX TOUR доплаты за автомобиль.',
  'booking.telegramPrefill': 'Имя и Telegram подставляются автоматически, если Telegram уже передал их Mini App. Телефон Telegram сам по себе не раскрывает — его просим только когда он неизвестен.',
  'booking.cancelPolicy': 'Перенос бесплатно до 17:00 за день до экскурсии; после — удержание 30%. Отмена бесплатно более чем за 48 часов; до 17:00 за день до выезда — удержание 30%; в день выезда или при неявке — 100%.',
  'booking.refundPolicy': 'Возврат — до 7 рабочих дней; возможны банковские комиссии. Реальный автоматический refund появится вместе с платёжным provider webhook.',
  'booking.processing': 'Рассчитываем…',
  'booking.creating': 'Создаём заказ…',
  'booking.orderCreated': 'Заказ создан',
  'booking.processingPayment': 'Обрабатываем…',
  'booking.continue': 'Продолжить',
  'booking.childHeight': 'Рост ребёнка',
  'booking.travelersCount': 'путешественников',
  'payment.sbp': 'СБП',
  'payment.sbpNote': 'Россия · online',
  'payment.kaspi': 'Kaspi',
  'payment.kaspiNote': 'Казахстан · online',
  'payment.vnpay': 'VNPay',
  'payment.vnpayNote': 'Вьетнам · online',
  'payment.card': 'Банковская карта',
  'payment.cardNote': 'provider после подключения',
  'payment.transfer': 'Банковский / международный перевод',
  'payment.transferNote': 'по реквизитам',
  'payment.other': 'Другой способ',
  'payment.otherNote': 'через менеджера',
  ...
  'catalog.sync': 'синхронизация…',
  'catalog.pages': 'страниц туров',
  'catalog.photos': 'фото',
  'catalog.more': 'Подробнее →',
  'catalog.from': 'от',
  'catalog.priceOnPage': 'Стоимость — по странице тура',
  'catalog.viNote': 'Вьетнамская версия показывает туры, для которых уже подготовлен структурированный перевод.',
...
const vi: Record<string, string> = {
  ...
  'booking.noPrivateRate': 'Nguồn hiện chưa có bảng giá tour riêng đủ rõ để tính tự động.',
  'booking.noPrivateRateText': 'Hệ thống không tự tạo giá. Khi bảng giá MAX TOUR được xác nhận trong Admin, tour này sẽ có thể checkout online.',
  'booking.priceServer': 'Giá tour riêng được máy chủ tính từ bảng giá đã công bố của từng tour.',
  'booking.transferText': 'Các khu vực xa áp dụng phụ phí xe theo bảng giá MAX TOUR đã công bố.',
  'booking.telegramPrefill': 'Tên và Telegram được điền tự động nếu Mini App nhận được dữ liệu từ Telegram. Số điện thoại không được Telegram tự động cung cấp nên chỉ hỏi khi cần.',
  'booking.cancelPolicy': 'Đổi lịch miễn phí đến 17:00 ngày trước tour; sau đó giữ 30%. Hủy trước hơn 48 giờ miễn phí; đến 17:00 ngày trước khởi hành giữ 30%; trong ngày khởi hành hoặc không đến giữ 100%.',
  'booking.refundPolicy': 'Hoàn tiền trong tối đa 7 ngày làm việc; có thể phát sinh phí ngân hàng. Hoàn tiền tự động sẽ hoạt động khi kết nối webhook của nhà cung cấp thanh toán.',
  'booking.processing': 'Đang tính…',
  'booking.creating': 'Đang tạo đơn…',
  'booking.orderCreated': 'Đơn đã tạo',
  'booking.processingPayment': 'Đang xử lý…',
  'booking.continue': 'Tiếp tục',
  'booking.childHeight': 'Chiều cao trẻ',
  'booking.travelersCount': 'hành khách',
  'payment.sbp': 'SBP',
  'payment.sbpNote': 'Nga · online',
  'payment.kaspi': 'Kaspi',
  'payment.kaspiNote': 'Kazakhstan · online',
  'payment.vnpay': 'VNPay',
  'payment.vnpayNote': 'Việt Nam · online',
  'payment.card': 'Thẻ ngân hàng',
  'payment.cardNote': 'sau khi kết nối nhà cung cấp',
  'payment.transfer': 'Chuyển khoản ngân hàng / quốc tế',
  'payment.transferNote': 'theo thông tin tài khoản',
  'payment.other': 'Phương thức khác',
  'payment.otherNote': 'qua quản lý',
  ...
  'catalog.allPlaces': 'Tất cả điểm đến',
  'catalog.sync': 'đang đồng bộ…',
  'catalog.pages': 'trang tour',
  'catalog.photos': 'ảnh',
  'catalog.more': 'Chi tiết →',
  'catalog.from': 'từ',
  'catalog.priceOnPage': 'Giá theo trang tour',
  'catalog.viNote': 'Phiên bản tiếng Việt hiển thị các tour đã có bản dịch cấu trúc được xác nhận.',
