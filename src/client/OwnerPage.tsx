...
export function OwnerPage() {
  ...
  const flush=async()=>{setFlushing(true);try{await api.flushTelegram();setIntegration(await api.telegramStatus())}finally{setFlushing(false)}};
