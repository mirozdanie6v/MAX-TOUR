...
function inferredOrigin(body = {}) {
  ...
  const patterns = [
    ['Нячанг', /(?:я|мы|сейчас|нахожусь|находимся|живу|живем|выезд|старт|отправляемся|едем из)[^.!?]{0,50}\bнячанг(?:е|а)?\b/],
    ['Дананг', /(?:я|мы|сейчас|нахожусь|находимся|живу|живем|выезд|старт|отправляемся|едем из)[^.!?]{0,50}\bдананг(?:е|а)?\b/],
    ['Ханой', /(?:я|мы|сейчас|нахожусь|находимся|живу|живем|выезд|старт|отправляемся|едем из)[^.!?]{0,50}\bхано(?:й|е|я)\b/],
    ['Фукуок', /(?:я|мы|сейчас|нахожусь|находимся|живу|живем|выезд|старт|отправляемся|едем из)[^.!?]{0,50}\bфу\s*куок(?:е|а)?\b/],
    ['Муйне', /(?:я|мы|сейчас|нахожусь|находимся|живу|живем|выезд|старт|отправляемся|едем из)[^.!?]{0,50}\b(?:муйне|фантьет(?:е|а)?)\b/],
  ];
