...
console.log(`Built standalone v28: ${catalog.length} tours with curated location-correct imagery + photo lightbox + live trip/departure policy + AI consultant v8 network guard, v15 selection ranking and v16 explicit-tour guard + v7 catalog-card parity + admin v3 + director v3 + Telegram analytics; exact source checksums verified.`);
